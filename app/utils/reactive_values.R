...
stage_name_rv <- if (LEAGUE_SCHEMA == "mls") c("Regular Season", "MLS is Back Group Stage") else c("Regular Season", "NWSL Challenge Cup Group Stage")
...
tables_rv <-
  reactiveValues(xgoals_players = list(minimum_minutes = 0,
                                       ...
                                       general_position = general_positions,
                 ...
                 goals_added_players = list(minimum_minutes = 0,
                                            ...
                                            start_date = paste0(max(all_seasons), "-01-01"),
                                            end_date = paste0(max(all_seasons), "-12-31"),
                                            general_position = general_positions[general_positions != "GK"],
                                            team_id = all_teams$team_id,
                                            split_by_teams = FALSE,
                                            split_by_seasons = TRUE,
                                            stage_name = stage_name_rv,
                 ...
                 goals_added_teams = list(season_name = max(all_seasons),
                                          zone = c(1:30),
                                          gamestate_trunc = c(-2:2),
                                          split_by_seasons = TRUE,
                                          stage_name = stage_name_rv,
                                          normalize_by = "None",
